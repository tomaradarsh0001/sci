        ...
        <div class="breadcrumbs-wrap">
            <div class="container">
                <div class="breadcrumbs">
                    ...
                    <span>Dr. Nabanita Chatterjee</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Nabanita Chatterjee </h5>
                            <p class="degree_section">General surgeon</p>
                            <p class="degree_section">MS - General Surgery</p>
                            <p class="degree_section">28 years overall (23 yrs speacialist)</p>
