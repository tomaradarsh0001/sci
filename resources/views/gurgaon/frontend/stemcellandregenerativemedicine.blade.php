            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 mt-md-0">
                    ...
                    <div class="service-img">
                        <img src="{{asset('public_gurgaon/assets/images/banner/Stem-Cell-Treatment-at-SCI-Hospital.png')}}" class="img-fluid" alt="" />
                    </div>
                        ...
                        <div class="col-sm-12 mt-20">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="doctor_ab">
                                        <img src="{{asset('public_gurgaon/assets/images/doctors/user.png')}}" class="w-100" alt="" />
                                        <p class="name_ab_doc">Dr. Vishnu Bhasin</p>
                                    </div>
                                </div>
