            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 mt-md-0">
                    ...
                    <div class="service-img">
                        <img src="{{asset('public_gurgaon/assets/images/banner/10.png')}}" class="img-fluid" alt="" />
                    </div>
                        ...
                        <div class="col-sm-12 mt-20">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="doctor_ab">
                                        <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Himanshu-Shekhar.png')}}" class="w-100" alt="" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="images_gallery_ab">
                                        <img src="{{asset('public_gurgaon/assets/images/img-gallery/image 600x355.png')}}" class="w-100" alt="" />
