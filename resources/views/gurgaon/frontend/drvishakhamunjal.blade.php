...
<script type="application/ld+json">
{
  ...
  "@type": "Person",
  "name": "Dr. VishakhaMunjal",
  "url": "https://scihospital.com/drvishakhamunjal",
  "image": "https://scihospital.com/public/assets/images/doctors/Dr-vishakha.jpg",
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-vishakha.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Vishakha Munjal</h5>
                            <p class="degree_section">MD – Obstetrics & Gynaecology – All India Institute of Medical Sciences, New Delhi, 1992</p>
                            ...
                            <div class="tab_doctors">
                                ...
                                <div id="tab-content" class="tab-content mt-2">
                                    ...
                                    <div id="tab-B" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Spardha Shree’ Award for Outstanding Social Service in the Field of Medicine in April – 2002</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
