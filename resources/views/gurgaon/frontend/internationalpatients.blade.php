        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Fully NABH Hospital (Govt. of India accreditation for Quality Treatments).png')}}" class="img-fluid" alt="" /> Fully NABH Hospital (Govt. of India accreditation for Quality Treatments)
                    </p>
                    <!--<div class="">
                        <ul class="international-list">
                            <li><img src="{{asset('public_gurgaon/assets/images/internationalpatients/Fully NABH Hospital (Govt. of India accreditation for Quality Treatments).png')}}" class="img-fluid" alt="" /> Fully NABH Hospital (Govt. of India accreditation for Quality Treatments)</li>
                        </ul>
                    </div>-->
                </div>
                ...
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Internationally Trained Doctors.png')}}" class="img-fluid" alt="" /> Internationally Trained Doctors
                    </p>
                ...
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Economical Price compared to other Hospital in Delhi.png')}}" class="img-fluid" alt="" /> Economical Price compared to other Hospital in Delhi
                    </p>
                </div>
                <div class="col-md-3 mb-3">
                     <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Latest Technique for Best Treatment Result.png')}}" class="img-fluid" alt="" /> Latest Technique for Best Treatment Result
                    </p>
                </div>
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Best Laser & Microscopes.png')}}" class="img-fluid" alt="" /> Best Laser & Microscopes
                    </p>
                </div>
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/State of the Art Ultra-Modern OT’s.png')}}" class="img-fluid" alt="" /> State of the Art Ultra-Modern OT’s
                    </p>
                </div>
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Spacious Private Room & Suites.png')}}" class="img-fluid" alt="" /> Spacious Private Room & Suites
                    </p>
                </div>
                <div class="col-md-3 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Well Trained Medical Staff & Nursing.png')}}" class="img-fluid" alt="" /> Well Trained Medical Staff & Nursing
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-6">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Old Medical reports.png')}}" class="img-fluid" alt="" /> Old Medical reports
                    </p>
                </div>

                <div class="col-md-4 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/VISA.png')}}" class="img-fluid" alt="" /> Visa
                    </p>
                </div>
                <div class="col-md-4 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Passport.png')}}" class="img-fluid" alt="" /> Passport
                    </p>
                </div>
                <div class="col-md-4 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Copy of the quotation & treatment plan provided by SCI.png')}}" class="img-fluid" alt="" /> Copy of the quotation & treatment plan provided by SCI
                    </p>
                </div>
                <div class="col-md-4 mb-3">
                    <p class="img_content">
                        <img src="{{asset('public_gurgaon/assets/images/internationalpatients/Photograph (Passport Size).png')}}" class="img-fluid" alt="" /> Photograph (Passport Size)
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="doctor-page-photo text-center">
                        <img src="{{asset('public_gurgaon/assets/images/services/international.png')}}" class="img-fluid" alt="" />
                    </div>
                </div>
                ...
                <div class="col-md mt-3 col-lg-12">
                    <div class="pr-0 pr-lg-8">
                        ...
                        <div class="doctor-box-bottom top_border_none">
                            <a href="{{ route('gurgaon.make-an-appointment') }}" class="btn btn-sm btn-hover-fill"><i class="icon-right-arrow"></i><span>Book An Appointment</span><i class="icon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
            </div>
