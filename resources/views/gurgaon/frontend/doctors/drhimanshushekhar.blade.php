...
@section('gurgaon.define_urltype', 'website') @section('gurgaon.ob_img', 'https://scihospital.com/gurgaon/public/assets/images/doctors/Dr-Himanshu-Shekhar.png')
...
{ 
  ...
  "url": "https://scihospital.com/gurgaon/dr-himanshu-shekhar", 
  "image": "https://scihospital.com/gurgaon/public/assets/images/doctors/Dr-Himanshu-Shekhar.png", 
                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Himanshu-Shekhar.png')}}" class="img-fluid" alt="Dr. Himanshu Shekhar Sci Hospital Gurugram" />
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="tab_doctors">
                                ...
                                <div id="tab-content" class="tab-content mt-2">
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>A dynamic Medical Director (Physician) with 17 years of experience at SCI Multispeciality Hospital, Guruguram, He combines his medical postgraduate qualification with his hospital management qualification to bring an innovative and patient-centric approach to healthcare. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab-B" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Dr. Himanshu Shekhar holds Medical Postgraduate and Hospital Management Qualifications, blending medical expertise with managerial skills for innovative, patient-centered healthcare approaches.</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-12 gallery_doc mt-2">
                            <h2 class="theme-color ">Image link for Acheivment</h2>
