                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. V.k. Rajoria</h5>
                            <p class="degree_section">Senoir Consultant (Neuro Spine Surgeon)<br>MBBS,MS,M.Ch </p>
                                    ...
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>MBBS,MS,M.Ch(AIIMS),Senoir Consultant Neurosurgery & Spine Surgery  </p>
                                            </div>
                                        </div>
                                    </div>
