                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Aashima Chopra </h5>
                            <p class="degree_section">MBBS, DNB - ENT</p>
                                    ...
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>9 Years Experience Overall  (6 years as specialist)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
