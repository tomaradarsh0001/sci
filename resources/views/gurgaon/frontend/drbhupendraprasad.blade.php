                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Bhupendra Prasad  </h5>
                            <p class="degree_section">General surgeon<br>MBBS, MS laparoscopic surgeon</p>
