                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. S. Sen Gupta </h5>
                            <p class="degree_section">MD MEDICINE</p>
                            <p class="degree_section">MBBS, MD
General Physician, Delhi</p>
                                    ...
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>MBBS, MD General Physician, Delhi</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
