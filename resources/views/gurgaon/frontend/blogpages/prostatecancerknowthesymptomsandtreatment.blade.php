            ...
            <div class="row">
                <div class="col-lg-9 mb-4">
                    <div class="blog-card-details">
                        <img src="{{asset('public_gurgaon/assets/images/blog/Prostate-Cancer-Causes-Symptoms-Treatment-Options.png')}}" alt="" class="img-fluid mb-3" />
                        ...
                        <h2> <a href="https://scihospital.com/enlarged-prostate">Benign Prostatic Hyperplasia </a>  (BPH):</h2>
                        <ul class="list_blog">
                        ...
                        <h3><b>Learn About the Prostate cancer Treatment Options </b> </h3>
