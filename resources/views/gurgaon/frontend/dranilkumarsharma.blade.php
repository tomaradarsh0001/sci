        ...
        <div class="breadcrumbs-wrap">
            <div class="container">
                <div class="breadcrumbs">
                    ...
                    <span>Dr. Anil Kumar Sharma</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Anil Kumar Sharma</h5>
                            <p class="degree_section">MBBS, MD - Medicine<br/>General Physician <br></p>
