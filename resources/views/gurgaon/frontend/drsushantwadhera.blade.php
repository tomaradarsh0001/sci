...
<script type="application/ld+json">
{
  ...
  "@type": "Person",
  "name": "Dr. SushantWadhera",
  "url": "https://scihospital.com/dr-sushant-wadhera",
  "image": "https://scihospital.com/public/assets/images/doctors/Sushant-200x200.jpg",
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Sushant-200x200.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2 theme-color">Dr. Sushant Wadhera</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="tab_doctors">
                                ...
                                <div id="tab-content" class="tab-content mt-2">
                                    <div id="tab-A" class="tab-pane in show active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Laproscopic Surgeon & Bariatric Surgeon</p>
                                                <p>M.B.B.S, M.S.-Gen Surgery</p>
                                                <p>FNB (MAS)</p>
                                                <p>Experience of 15 Years (13 years as specialist)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
