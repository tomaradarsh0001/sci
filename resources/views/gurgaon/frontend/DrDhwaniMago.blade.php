                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Dhwani-Mago-300x300.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Dhwani Mago</h5>
                            <p class="degree_section">OB-GYN, DGO, PGDS
Junior Consultant – Obstetrics & Gynaecology</p>
                            ...
                            <div class="tab_doctors">
                                ...
                                <div id="tab-content" class="tab-content mt-2">
                                    ...
                                    <div id="tab-D" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <img src="{{asset('public_gurgaon/assets/images/img-gallery/rcsengh-logo-150x90-1.gif')}}" class="img-fluid" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
