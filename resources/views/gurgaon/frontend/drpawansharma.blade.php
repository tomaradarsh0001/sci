                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Pawan.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Pawan Sharma</h5>
                            <p>MBBS, MD - General Medicine 9 Years Experience</p>
                                    ...
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Dr. Pawan Sharma is a General Physician and Internal Medicine in Gurgaon and has an experience of 9 years in these fields. Dr. Pawan Sharma practices at SCI hospital in Sector 43, Gurgaon. He completed MBBS from Pravara Institute of Medical Sciences, Loni in 2015 and MD - General Medicine from Kalinga Institute of Medical Sciences, Bhubaneswar in 2021.</p>
                                                </div>
                                        </div>
                                    </div>
