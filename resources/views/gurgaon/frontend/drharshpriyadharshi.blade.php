        ...
        <div class="breadcrumbs-wrap">
            <div class="container">
                <div class="breadcrumbs">
                    ...
                    <span>Dr. Harsh Priyadharshi </span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Harsh Priyadharshi </h5>
                            <p class="degree_section">Orthopedic Spine Specialist  -  MBBS, MS - Orthopaedics</p>
