            ...
            <div class="row pb-5">
                <div class="col-md col-lg-5">
                    <div class="pr-0 pr-lg-8">
                        ...
                        <ul class="icn-list-lg mt-2">
                            <li>
                                <i class="icon-telephone"></i>Phone : <span class="theme-color"><span class="text-nowrap"><a href="tel:9999446622">+91 9999446622</a> (For Appointment)</span> </span> <br />
                                Fax: <span class="theme-color"><span class="text-nowrap"><a href="tel:1141675555">011 4167 5555</a> (For General Queries)</span> </span>
                            </li>
                            <li><i class="icon-placeholder2"></i>M 4, Near M Block, Greater Kailash-1, New Delhi 110048</li>
                ...
                <div class="col-md col-lg-6 mt-4 mt-md-0">
                    <form action="{{ url('contact-form') }}" class="contact-form forms" id="" method="post" novalidate="novalidate">
                        ...
                        <div class="mt-3">
                            ...
                            <button type="submit" class="btn btn-hover-fill"><span>Send message</span><i class="fa fa-spinner fa-spin" style="display:none;"></i><i class="icon-right-arrow"></i></button>
                        </div>
                    </form>
                </div>
            </div>
