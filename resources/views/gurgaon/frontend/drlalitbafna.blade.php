                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Lalit-Bafna-200x200.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2 theme-color">Dr. Lalit Bafna</h5>
                            <p class="degree_section">MBBS,MS (ortho), DNB(ortho) FNB (Sports Medicine),MNAMS</p>
                            <ul class="list_details_doc">
                                ...
                                <li><i class="fa fa-phone"></i> Mobile: <a href="tel:8178879594" style="color:black"> +91-8178879594</a></li>
                                ...
                                <div id="tab-content" class="tab-content mt-2">
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Fellowship in Advance Knee & Shoulder Surgery (USA) 10 Years of Experience Ex. Sr Resident at AIIMS EX. Consultant at Max Hospital, Saket</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab-B" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>
                                                    11 years overall (8 yrs as specialist)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
