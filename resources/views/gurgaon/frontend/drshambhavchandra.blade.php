                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('public_gurgaon/assets/images/doctors/Dr_Shambhav.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr Shambhav Chandra</h5>
                                    ...
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Dr. Shambhav Chandra is an experienced General Surgeon, Bariatric Surgeon, Proctologist and Laparoscopic Surgeon and has an experience of 12 years. He completed MBBS from D Y Patil Medical College Kolhapur in 2013 and MS - General Surgery from D Y Patil Medical College Kolhapur in 2018. He provides specialized treatment for Piles, Fissure, Fistula, Abscess, Pilonidal Sinus, Anal Polyps, Anal Warts, Rectal Prolapse, Toenail, Urethral Stricture, Erectile Dysfunction, Urinary Tract Infection, Urinary Incontinence, Balnitis, Phimosis, Paraphimosis, General Uro, Umbilical Hernia, Inguinal Hernia, Incisional Hernia, Hiatus, Gallstones, Bariatrics, Stent Removal, Cyst Removal, Hydrocele, and several other conditions.</p>
                                                </div>
                                        </div>
                                    </div>
