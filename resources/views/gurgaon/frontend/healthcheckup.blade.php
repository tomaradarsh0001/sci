            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 mt-md-0">
                    ...
                    <div class="service-img">
                        <img src="{{asset('public_gurgaon/assets/images/banner/Health-Check-Up-Banner-SCI.png')}}" class="img-fluid" alt="" />
                    </div>
                            ...
                            <p class="theme-color font-heading-bold">Our Doctors</p>
                             ...
                             <div class="row">
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="doctor_ab">
                                        <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Saurabh-Jethi-300x300.png')}}" class="w-100" alt="" />
                                ...
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="doctor_ab">
                                        <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Anirban-Biswas.png')}}" class="w-100" alt="" />
                                ...
                                <div class="col-lg-4 col-md-6 text-center">
                                    <div class="doctor_ab">
                                        <img src="{{asset('public_gurgaon/assets/images/doctors/Dr-Sanchayan-Roy.png')}}" class="w-100" alt="" />
