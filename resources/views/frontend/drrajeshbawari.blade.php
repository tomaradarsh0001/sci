                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('assets/images/doctors/DR-Rajesh-Bawari-200x200.jpg')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="tab_doctors">
                                <div class="row nav nav-pills-icons js-doc-carousel" role="tablist">
                                    <a class="nav-link active" data-toggle="pill" href="#tab-A" role="tab"><i class="fa fa-sticky-note-o"></i> 
ABOUT</a>
                                </div>
