                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Embrace your Personalised Motherhood Journey with us</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Complete Setup for Normal delivery, High-Risk Pregnancies & C-section
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Team of Experienced Gynecologists, Neonatologist, Pediatrician, Support Staff & Level III NICU
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Carefully crafted Maternity packages for comprehensive birthing experience
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Top Choice for Diplomats and Embassies
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/Maternity Banner_BG_Desktop -1440x635.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/Maternity Banner_BG_Mobile - 415x1064.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About <span>Maternity Care</span></h2>

				<div class="h-text">

				    <p>Pregnancy and childbirth are life-changing experiences for any woman, calling for the need of comprehensive care services such as Antenatal Care, Delivery Support, Postpartum Support, and more.</p>
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item active" role="presentation">
                    ...
                    <div class="nav-link" id="Symptoms-tab" data-toggle="pill" data-target="#Symptoms" role="tab" aria-controls="Symptoms" aria-selected="true">How Are We The Best?</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Treatment-tab" data-toggle="pill" data-target="#Treatment" role="tab" aria-controls="Treatment" aria-selected="false">Why is Maternity Care Needed?</div>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>How Are We The  <span>Best?</span></h3>

                              <p> At SCI Hospital, our distinguished track record includes over 10,000 successful deliveries led by a team of 15+ experienced mother and child care specialists with over 11 years of expertise. Offering comprehensive services spanning fertility, maternity, delivery, and pediatric care, we provide expectant mothers with unparalleled support. </p>

                              <h6>Our exclusive facilities include:</h6>

                              <ul>

                              <li>Complete set-up for all birthing options</li>

                              <li>Certified Gynecologists, Pediatricians and Neonatologist</li>

                              <li>Complete antenatal program: counseling, scans, nutrition.</li>

                              <li>Expertise in handling high-risk pregnancies</li>

                              <li>Expert preterm baby care</li>

                              <li>Level III NICU with a capacity of 15 beds</li>

                              <li>Best Neonatal Care</li>

                              </ul>

                              <p>Advanced Delivery Setup   Board-certified Gynecologists Special Care Nursery  Trained Staff</p>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Why is Maternity <span>Care Needed?</span></h3>

                              <p>Maternity care is vital for the health of the mother and her baby. It involves various types of screenings and tests. At SCI International Hospital, our round-the-clock maternity care can keep the mother safe against the following complications: </p>

                              <!--<h6> </h6>-->

                              <ul><li>Gestational Diabetes</li>
                              ...
                              <p>Efficient maternity care is needed to reduce the chances of such complications.</p>
    ...
    <section class="cost-estimate-sec">
        ...
        <div class="container">
            ...
            <div class="cost-estimate-box">
                ...
                <h3>Check <span>Maternity Package Cost</span></h3>

                <p>We believe in transparency. You can enquire about the Maternity package Cost and we will help you with complete detailed treatment process till your recovery.</p>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top Gynecologists<span> & Obstetricians Today</span></h2>

				<div class="h-text"><p>Select from our internationally-trained maternity care experts, with an experience of 11+ years.</p></div>
            ...
            <div class="owl-carousel owl-theme" id="lp_page_doctor">
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="{{asset('assets/images/doctors/Dr-Dhwani-Mago-300x300.jpg')}}" alt="" width="100%" class="img-fluid" /></div>
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="{{asset('assets/images/doctors/Dr-Ruchi-Tandon.png')}}" alt="" width="100%" class="img-fluid" /></div>
                        ...
                        <div class="our-team-text">
                           ...
                           <!-- <a href="{{ route('dr-ruchi-tandon') }}" class="view-all-link">View Full Profile</a>-->
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="{{asset('assets/images/doctors/Shilpi.jpg')}}" alt="" width="100%" class="img-fluid" /></div>
                        ...
                        <div class="our-team-text">
                           ...
                           <!-- <a href="{{ route('dr-shilpi-singh') }}" class="view-all-link">View Full Profile</a>-->
				...
				<div class="col-md">
						...
						<div class="our-team-box">
							...
							<div class="our-team-img"><img src="{{asset('assets/images/doctors/dr-hena-kausar.webp')}}" alt="" width="100%" class="img-fluid" /></div>
							...
							<div class="our-team-text">
								...
								<p>Laparoscopic Surgeon (Obs & Gyn)</p>
    ...
    <div class="section testimonial-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<div class="h-text"><p>What Are The Happy Mothers Saying About The Maternity Care They Received?</p></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Pankaj Dagar</h5></div>

                        </div>

                        <div class="testimonial-body">

                            Really good experience with the hospital. We came here for the delivery of our child and they took care of us very well. Special mention to Dr Dhwani, Dr Niraj and Dr Shahla for explaining everything in detail and answering all our queries with patience. Thanks to all the nursing staff along with duty doctors for taking care of my family through day and night. Also, a big thankyou to our coordinator Usha ji for arranging everything properly.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Mrs. Sophia John</h5></div>

                        </div>

                        <div class="testimonial-body">

                            Expressing gratitude to the entire team at SCI Hospital feels insufficient. We had lost hope of a natural birth, but from our first visit, they provided reassurance and instilled hope. Their demonstration of true "CARE" surpasses any expectation. There is simply no comparison to the exceptional support we received.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Mrs. Ranjana Padmanavan</h5></div>

                        </div>

                        <div class="testimonial-body">

                            My experience at SCI Hospital was empowering. Unlike other hospitals, where visits felt rushed, here the doctors listen attentively, explain thoroughly, and prescribe only necessary medications. They prioritize emotional well-being, encourage healthy habits, and offer unwavering support. Even after knowing that I had a low-lying placenta issue, I stayed calm. That’s because of the doctors at SCI!
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions About </span> Maternity Care </h2>

				<div class="h-text"><p>For any maternity-care related query, go through this FAQ section.</p></div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingOne">
                         ...
                         <div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           ...
                           When are sonographies required in pregnancy?
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           During pregnancy, expect ultrasound, blood, urine, and GBS tests. These screenings aid in detecting potential health risks. Discuss any concerns with your doctor.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingTwo">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           ...
                           When can I go home after childbirth?
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            For Vaginal births, patients are discharged in two days while for C-Section patients are usually discharged in three to four days, barring complications.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingThree">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            ...
                            What birthing options do I have?
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Vaginal delivery is the safest and most natural option. The other options include C-Section, Vaginal Birth After C-Section, and Scheduled Induction.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            ...
                            In how much time does my C-Section incision heal?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Generally, 4-6 weeks are needed for C-Section recovery, but individual experiences vary. Some women may need 24 weeks for complete recovery from C-Section.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingFive">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            ...
                            What could be a maternity emergency?
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            There are certain warning signs to indicate a maternity emergency. The major signs are:
                    ...
                    <div class="card">
                      ...
                      <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Yes, labor is severely painful, but the joy that follows diminishes the memory of that pain. The happiness of delivering a baby far surpasses the pain.
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>Experience a safe, easy & rewarding pregnancy journey with us.</p>
