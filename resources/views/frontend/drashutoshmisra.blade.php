                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('assets/images/doctors/Ashutosh.webp')}}" class="img-fluid" alt="Dr. Ashutosh Misra" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h1 class="doctor-box-name mb-2  theme-color">Dr. Ashutosh Misra |  Best Plastic & Cosmetic Surgeon </h1>
                            <p class="degree_section">Senior Consultant <br>Plastic & Cosmetic Surgeon</p>
