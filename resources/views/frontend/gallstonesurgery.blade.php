                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Latest Gallstone Surgery in Delhi NCR</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" /> Experienced Doctors
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Latest Laparoscopic Procedure
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Cashless Facility for All Major Insurances and no cost EMI 
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/GallbladderBG_Desk.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/GallbladderBannerMob.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About Gallstone <span>Surgery</span></h2>

				<div class="h-text">

				    <p>Gallstone surgery is a laparoscopic procedure to remove a diseased gallbladder through small incisions. This minimally invasive procedure is mainly used to treat gallstone problems.</p>
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    ...
                    <div class="nav-link" id="Sci-tab" data-toggle="pill" data-target="#Sci" role="tab" aria-controls="Sci" aria-selected="false">SCI vs. Others</div>
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Symptoms For Gallstone  <span>Formation</span></h3>

                              <!--<p> </p>-->

                              <h6>The signs & symptoms of gallstone issue are:</h6>

                              <ul>

                              <li>Constant, sharp or dull pain in the middle upper or right upper abdomen</li>

                              <li>Nausea & vomiting </li>

                              <li>Light-colored stools</li>

                              <li>Tea-colored urine</li>
                             ...
                             <li>Low grade fever</li>
                              ...
                              <p>If you are experiencing any of these symptoms, you may need a gallstone surgery</p>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                            ...
                            <h3>Why Is <span>Treatment </span> Needed?</h3>

                              <p>It is not wise to leave gallstones untreated. Untreated gallstones may increase the severity of the symptoms such as pain and vomiting. Also, delay in treatment may cause complications such as:</p>

                            <!--  <h6>The primary triggers behind hip joint damage are: </h6>-->

                              <ul><li>Gallbladder inflammation</li>

                              <li>Severe infection of the gallbladder, pancreas or bile duct</li>

                              <li>Jaundice</li>

                              <li>Abscess formation</li>

                              <li>Heightened risk of gallbladder cancer</li>
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <li>Relief from inflammation</li>

                              <li>Reduced chances of complications</li>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>The gallstone surgery costs vary based on the room category chosen, aftercare and patient’s health status. They are covered by a cashless insurance facility, and patients have 0% EMI options available. </p>
                  ...
                  <div class="tab-pane fade" id="Sci" role="tabpanel" aria-labelledby="Sci-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>SCI vs. <span>Others</span></h3>

                              <p> Experience the SCI difference in Gallstone Surgery. Our advanced laparoscopy method surpasses traditional methods, ensuring superior outcomes. Explore the table below to discover how SCI stands out: </p>
                              ...
                              <table style="width:100%; margin-bottom:30px;">
                                  ...
                                  <tr>
                                    ...
                                    <th>Laparoscopy Gallstone Surgery at SCI</th>

                                  </tr>

                                  <tr>

                                    <td>Scars & Stitches</td>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top Laparoscopic  <span>Surgery Specialists Today </span></h2>
            ...
            <div class="owl-carousel owl-theme" id="lp_page_doctor">
              ...
              <!--  <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="{{asset('assets/images/doctors/dr-shitij-arora.webp')}}" alt="" width="100%" class="img-fluid" /></div>
                        ...
                        <div class="our-team-text">
                            ...
                            <a href="{{ route('dr-shitij-arora') }}" class="view-all-link">View Full Profile</a>
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-text">
                            ...
                            <h5>General Surgeon, Piles, Fissure, Fistula Surgeon</h5>
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-text">
                            ...
                            <h5>Piles, Fissure, Fistula Surgeon not ayurvedic surgeon</h5>
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-text">
                            ...
                            <h5>Proctology/General Surgeon</h5>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Pandu Rangan</h5></div>

                        </div>

                        <div class="testimonial-body">

                            I had great experience at SCI INTERNATIONAL HOSPITAL. I had Ms Usha who assisted me during my registration. She is so accommodating. Thanks to the nursing staff who never fail to explain everything about my treatment and special thanks to Dr Vicky Kuldeep who showed concern for his patients.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Paramjeet Singh </h5></div>

                        </div>

                        <div class="testimonial-body">

                          <p>After consulting from Artemis and Paras Hospital, wherein my wife detected Gallbladder stone and advised for surgery. I started a Google search near Gurgaon and my search ended at Dr. Daipayan Ghosh. He is one of the most empathic, efficient, and brilliant doctors. My wife is living a normal life within 5 days post her surgery without any pain and worry of her diet issues.</p>

                 <p>  Another point to highlight here is the new hospital in sector 43 Gurgaon i.e., SCI International Hospital on Golf Course Road Gurgaon wherein the staff if very professional, maintain high-class of Hygiene standards along with very high quality of Rooms with very economical pricing.</p></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Rita Bansal</h5></div>

                        </div>

                        <div class="testimonial-body">

                            Choosing SCI Hospital for my gallstone surgery was the best decision I made. The entire process, from diagnosis to recovery, was handled with professionalism. The skilled surgeons and caring staff made me feel at ease throughout. I am grateful for their expertise and dedication, and I'm now enjoying a pain-free life post-surgery. Thank you, SCI Hospital!
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions About </span> Gallstone Surgery</h2>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingOne">
                         ...
                         <div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           ...
                           How can I avoid the formation of gallstones?
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Reduce gallstone risk with a healthy high-fiber diet and regular exercise. Emphasize fruits, vegetables, beans, whole grains like brown rice, oats, and whole wheat bread.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingTwo">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           ...
                           How much time does it take to recover from gallstone surgery?
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            After laparoscopic gallstone removal surgery, return to normal activities in 1-2 weeks, possibly longer. Open surgery may require 4-6 weeks for resuming routine.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingThree">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            ...
                            Can laparoscopic removal of gallstones cause an infection?
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            In case of laparoscopy, the gallstones and the gallbladder are removed through very small incisions, which means there is a very little chance of an infection.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            ...
                            What should be my duration of hospital stay after the laparoscopic gallbladder surgery?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           You will be made to stay in the hospital for one to two days after surgery. In case a complication arises, though very rare, you might have to extend your stay.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingFive">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                           ...
                           Can I lead a normal life after gallbladder surgery?
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Post-gallbladder surgery, normal life resumes. No need to worry about not having a gallbladder. Without it, bile flows from liver to intestine, aiding digestion as usual.
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <h2>Book an Appointment Today!</h2>
                         ...
                         <p>We can relieve you of gallbladder stones & the associated discomfort.</p>
