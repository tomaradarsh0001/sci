                ...
                <div class="gallery-smiles gallery-isotope" id="gallery">
                    <div class="gallery-item category1">
                        <div class="twentytwenty-container">
                            <img src="{{asset('assets/images/gallery/1K1A4900-min-768x512.jpg')}}" alt="" />
                        </div>
                    </div>
                    <div class="gallery-item category1">
                        <div class="twentytwenty-container">
                            <img src="{{asset('assets/images/gallery/corridor-768x336.jpg')}}" alt="" />
                        </div>
                    </div>
                    <div class="gallery-item category2">
                        <div class="twentytwenty-container">
                            <img src="{{asset('assets/images/gallery/Deluxe-Room-min-3-768x512.jpg')}}" alt="" />
                        </div>
                    </div>
                    <div class="gallery-item category2">
                        <div class="twentytwenty-container">
                            <img src="{{asset('assets/images/gallery/M1-min-768x509.jpg')}}" alt="" />
                        </div>
                    </div>
                    <div class="gallery-item category3">
                        <div class="twentytwenty-container">
                            <img src="{{asset('assets/images/gallery/OT...-min-768x512.jpg')}}" alt="" />
                        </div>
                    </div>
                    <div class="gallery-item category3">
                        <div class="twentytwenty-container">
                            <img src="{{asset('assets/images/gallery/Recovery-Area-min-768x512.jpg')}}" alt="" />
                        </div>
                    </div>
