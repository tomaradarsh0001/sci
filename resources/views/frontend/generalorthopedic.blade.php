                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Best Orthopedic Care Awaits at SCI Hospital, Delhi and Gurgaon's Most Trusted Healthcare Destination</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Expert Orthopedic Surgeons
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Best Quality Imported Implants
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Affordable Surgery Packages 
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />All Major Insurances Accepted & No Cost EMI Available
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/Ortho General Banner_BG_Desktop -1440x635.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/Ortho General Banner_BG_Mobile - 415x1064.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About <span>Treatment</span></h2>

				<div class="h-text">

				    <p>Our Orthopedic Treatments encompass surgeries, therapies, and interventions to alleviate musculoskeletal issues, aiming for pain relief, function restoration, and improved quality of life.</p>
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item active" role="presentation">
                    ...
                    <div class="nav-link" id="Symptoms-tab" data-toggle="pill" data-target="#Symptoms" role="tab" aria-controls="Symptoms" aria-selected="true">What Do We Treat?</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Treatment-tab" data-toggle="pill" data-target="#Treatment" role="tab" aria-controls="Treatment" aria-selected="false">How We Treat?</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Benefits-tab" data-toggle="pill" data-target="#Benefits" role="tab" aria-controls="Benefits" aria-selected="false">Benefits</div>
                  ...
                  <li class="nav-item" role="presentation">
                    ...
                    <div class="nav-link" id="Others-tab" data-toggle="pill" data-target="#Others" role="tab" aria-controls="Others" aria-selected="false">Cost</div>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>What Do We <span>Treat? </span></h3>
                              ...
                              <li>General Orthopedic Conditions: SCI Hospital treats a range of general orthopedic conditions including osteoarthritis, osteoporosis, fibromyalgia, and TMJ dysfunction. These conditions involve degenerative joint diseases, reduction of bone mass, chronic muscle pain, and jaw joint inflammation, leading to various symptoms like pain, fatigue, and difficulty in movement.</li>

                              <li>Shoulder Injuries: We also specialize in treating a spectrum of shoulder injuries, including dislocation, rotator cuff tears (operative or non-operative), frozen shoulder, fractures, tendinitis, arthritis, shoulder impingement syndrome, SLAP tears or labral tears/repairs, and thoracic outlet syndrome. Our comprehensive care addresses both operative and non-operative management of these conditions.</li>

                              <li>Neck & Low Back Injuries: Neck and low back injuries treated at SCI Hospital encompass stenosis, disc herniation, sprain/strain, muscle spasm, poor posture, SI joint dysfunction, and coccydynia. Our specialized care targets these conditions with tailored interventions for improved mobility and pain relief.</li>

                              <li>Elbow Injuries: We offer advanced treatment for elbow orthopedic conditions, including bursitis, fractures/dislocations, golfer's elbow (medial epicondylitis), sprain/strain (conservative or postoperative), and tennis elbow (lateral epicondylitis), providing tailored care for optimal recovery and function.</li>

                              <li>Wrist Injuries: We provide comprehensive treatment for wrist orthopedic conditions, including fractures, tendinitis, carpal tunnel syndrome, and sprain/strain (conservative or postoperative), offering both conservative and postoperative management options for optimal recovery.</li>

                              <li>Knee Injuries: We also offer comprehensive treatment for knee injuries, including tendinitis, patellofemoral syndrome, ligament strains, ACL tears (operative or non-operative), total knee replacement for osteoarthritis, meniscus tears (operative or non-operative), and hamstring or quadriceps strains/tears. Our approach encompasses both conservative and surgical interventions for optimal outcomes.</li>

                              <li>Hip Conditions: Comprehensive treatment for hip conditions, including bursitis, tendinitis, labral tears (anterior/posterior), IT band tightness/syndrome, groin strains, and total hip replacement for osteoarthritis is available with us. Our specialized care addresses both conservative management and surgical interventions for optimal recovery and relief.</li>

                              <li>Ankle Injuries: At SCI Hospital, we offer comprehensive treatment for ankle injuries, including peroneal tendonitis, Achilles' tendinitis, fractures, sprain/strain (conservative or post-operative), calf strains, shin splints, and tarsal tunnel syndrome. Our specialized care addresses both conservative and post-operative management to facilitate optimal recovery.</li>

                              <li>Foot or Toe Injuries: Here treatment is available for various foot and toe injuries, including bunionectomy, plantar fasciitis (heel pain), fractures/stress fractures, and sprain/strain (conservative or post-operative). Our specialized care encompasses both conservative and post-operative management to ensure optimal recovery for our patients.</li>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>How We <span>Treat? </span></h3>

                              <!--<p> </p>-->

                              <h6>Diagnosis: </h6>

                              <ul><li>Accurate assessment through imaging techniques like X-rays, MRI, and CT scans.</li>

                              <li>Detailed physical examination by orthopedic specialists to determine the extent and nature of the condition.</li>

                              </ul>

                              <h6>Surgical Interventions: </h6>

                              <ul>

                              <li>Invasive Surgeries:</li>

                              <p>Procedures such as total joint replacement for advanced arthritis.</p>

                              <p>Open reduction and internal fixation for fractures requiring realignment and stabilization.</p>

                              <li>Minimally Invasive Surgeries:</li>

                              <p>Arthroscopic procedures for conditions like torn ligaments or meniscus.</p>

                              <p>Minimally invasive spine surgery for disc herniation or spinal stenosis.</p>

                              </ul>

                              <h6>Rehabilitation: </h6>

                              <ul><li>Tailored physical therapy programs designed to restore mobility and strength.</li>

                              <li>Post-surgical rehabilitation focusing on pain management, functional recovery, and prevention of complications.</li>
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <!--<h6>The benefits & cost of the surgery are:</h6>-->

                              <ul>

                              <li>Restores mobility and function</li>

                              <li>Alleviate pain associated with musculoskeletal conditions</li>

                              <li>Address severe injuries and degenerative diseases</li>

                              <li>Enhances quality of life and promotes long-term well-being</li>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>Our Orthopedic Treatment costs vary by type, implant used and room choice, and are covered by insurance, with 0% Interest EMI available. </p>
    ...
    <div class="section why-us-container mt-0" id="services">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<div class="h-text"><p>SCi Hospital is one of the top orthopedic hospitals which offers the best medical-care facilities to patients suffering from various orthopedic conditions like knee, hip and joint issues and uses well-equipped advanced technology.</p></div>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top Orthopedic <span> Surgery Specialists Today!</span></h2>

				<div class="h-text"><p>Select from our internationally-trained surgeons, with an experience of 25,000+ surgeries.</p></div>
            ...
            <div class="owl-carousel owl-theme" id="lp_page_doctor">
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="{{asset('assets/images/doctors/Punit.png')}}" alt="" width="100%" class="img-fluid" /></div>

                        <div class="our-team-text">

                            <h3>Dr. Punit D.</h3>

                            <h5>Orthopaedics & Joint Replacement</h5>

                            <p>Orthopedic surgeon</p>

                          <!--  <a href="https://scihospital.com/gurgaon/dr-punit-dilawari" class="view-all-link">View Full Profile</a>-->
                ...
                <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="{{asset('assets/images/doctors/Dr-Lalit-Bafna-200x200.jpg')}}" alt="" width="100%" class="img-fluid" /></div>
                        ...
                        <div class="our-team-text">
                          ...
                          <!--  <a href="{{ route('dr-lalit-bafna') }}" class="view-all-link">View Full Profile</a>-->
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Ruhulla Wani</h5></div>

                        </div>

                        <div class="testimonial-body">

                           I am from Srinagar, Jammu and Kashmir. We recently visited SCI International Hospital with my mother for orthopedic surgery, performed by Dr. Mandeep Singh. The surgery was a resounding success, and after just one month, my mother has fully recovered. I must commend the dedicated care provided by nurse's helpers, Ms. Sudha and Ms. Renuka, during our stay. Their attentiveness and support were invaluable. SCI International Hospital truly excels in patient care and medical expertise, making it a highly recommended choice for anyone seeking quality healthcare and again we are very thankful to Doctor Mandeep Singh may God bless him.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Bipin Kadayat</h5></div>

                        </div>

                        <div class="testimonial-body">

                            I am coming after 6 months to this hospital. All staffs’ behavior is like family. They treat each other like a family. I feel very comfortable here. I am from NEPAL. THANKS TO EVERYONE IN SCI hospital.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <!-- <div class="testimonial-img"><img src="{{asset('assets/images/testi-4.jpg')}}" alt="" width="100%" class="img-fluid" /></div> -->

                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>R Shivansh</h5></div>

                        </div>

                        <div class="testimonial-body">

                            I recently visited SCI Hospital and I was impressed with the excellent facilities and knowledgeable staff. Overall I had a positive experience and I would definitely recommend this hospital to my relatives or friends.
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions About </span> Orthopedic Treatments</h2>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingOne">
                         ...
                         <div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           ...
                           How do I choose the best surgeon for orthopedic surgeries?
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           You must always look for board-certified Orthopaedic Surgeons with substantial surgical experience. These surgeons can handle your surgery the best way.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingTwo">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           ...
                           What is the recovery time after slip disc surgery?
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Recovery time varies but typically ranges from several weeks to a few months, depending on the individual's condition and procedure performed.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingThree">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                             ...
                             How long does a joint replacement surgery last?
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            The duration of joint replacement surgery varies but typically ranges from 1 to 3 hours, depending on the complexity and type of joint being replaced.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                           ...
                           What can I expect about orthopedic surgery after-care?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Orthopedic surgery after-care involves pain management, physical therapy, follow-up appointments, and adherence to post-operative instructions for optimal recovery and rehabilitation.
                    ...
                    <div class="card">
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Osteoarthritis treatment options include medication, physical therapy, lifestyle modifications, joint injections, and in severe cases, surgical interventions like joint replacement.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingSix">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseFive">
                      ...
                      <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Common risks include infection, bleeding, blood clots, anesthesia complications, nerve damage, and post-operative pain, though specific risks vary depending on the procedure.
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>Latest Treatments For All Ortho Complaints Available Here</p>
