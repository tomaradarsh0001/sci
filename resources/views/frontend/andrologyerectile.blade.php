                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Most trusted Erectile Dysfunction (ED)Treatment in Delhi NCR</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Expert Andrologists & Urologists
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Advanced Non-Invasive & Invasive Treatments
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Affordable Treatment Packages 
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />All Major Insurance Accepted & No Cost EMI Available
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/ErectileBanner_BG_Desktop.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/ErectileBanner_BG.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About Erectile <span>Dysfunction (ED)</span></h2>

				<div class="h-text">

				    <p>Erectile Dysfunction is a sexual dysfunction in which a man fails to get an erection or maintain an erection during sexual intercourse. Erectile dysfunction is also called impotence.</p>
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item active" role="presentation">
                    ...
                    <div class="nav-link" id="Symptoms-tab" data-toggle="pill" data-target="#Symptoms" role="tab" aria-controls="Symptoms" aria-selected="true">Symptoms</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Treatment-tab" data-toggle="pill" data-target="#Treatment" role="tab" aria-controls="Treatment" aria-selected="false">Why is Treatment Needed?</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Benefits-tab" data-toggle="pill" data-target="#Benefits" role="tab" aria-controls="Benefits" aria-selected="false">What Are Your Treatment Options?</div>
                  ...
                  <li class="nav-item" role="presentation">
                    ...
                    <div class="nav-link" id="Others-tab" data-toggle="pill" data-target="#Others" role="tab" aria-controls="Others" aria-selected="false">Why Are We The Best For Erectile Dysfunction Treatment?</div>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Signs that you need a <span>Erectile Dysfunction</span></h3>

                              <p>The three prime erectile dysfunction symptoms are:</p>

                             <ul><li>Getting weak erections not suitable for intercourse</li>

                             <li>Getting erections but unable to maintain it during intercourse</li>

                             <li>Not getting erections at all</li>

                             </ul>

                             

                            <p>Facing erection issues occasionally should not be a cause of worry but if the problem occurs routinely or increases with time, you must get yourself checked, as you might be needing erectile dysfunction treatment.</p>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Why is Treatment Needed?</h3>

                              <p>Erectile dysfunction needs treatment due to the following reasons:</p>

                           <!--   <h6>The primary triggers behind hip joint damage are: </h6> -->

                              <ul>

                              <li>It can cause relationship issues</li>

                              <li>It can cause male infertility</li>

                              <li>It can cause poor confidence levels, stress, anxiety and depression</li>

                               

                              </ul>

                              <P>Also, Erectile Dysfunction can indicate serious health issues like heart attack, stroke, atherosclerosis, and high blood pressure. Prompt treatment is crucial to address underlying conditions.</p>

                            <!---  <p>Any of the above triggers may damage your hip joint, making surgical intervention absolutely necessary.</p>-->
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>What Are Your <span> Treatment Options?</span></h3>

                              <p>Non-Invasive Options:</p>

                           <ul>

                               <li>Phosphodiesterase type-5 inhibitor pills</li>

                               <li>Shock wave lithography</li>

                               <li>Penile Injection</li>

                               <li>Vacuum Erection Devices</li>

                           </ul>

                           <h6>Invasive Option:</h6>

                           <p>Penile implant surgery treats ED from severe penile trauma by bypassing injured arteries. It's suitable for younger men but not recommended for older men with hardened arteries or nerve damage.</p>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                            ...
                            <h3>Why Are We The Best For Erectile  <span>Dysfunction Treatment?</span></h3>

                            <p>SCI International Hospital in Delhi is renowned for its outstanding erectile dysfunction treatment. Our multidisciplinary team of experts in urology, endocrinology, neurology, cardiovascular diseases, psychology, and psychiatry ensures comprehensive patient evaluation and care.</p>

                              <h6>Our Exclusive Attributes & Facilities Include:</h6>

                              <ul><li>Expertise: Our top-notch erectile dysfunction doctors in India bring years of experience and expertise to effectively diagnose and treat ED.</li>

                              <li>Cutting-Edge Technology: We leverage the latest advancements in medical technology to provide innovative and effective solutions for erectile dysfunction.</li>

                              <li>Comprehensive Care: From diagnosis to treatment and ongoing support, we offer a comprehensive approach to address all aspects of ED.</li>

                              <li>Patient-Centric Approach: Your comfort and well-being are our top priorities, and we tailor our treatments to meet your specific needs.</li>

                             <li>Private and Confidential: We understand the sensitive nature of ED, and our services are provided with the utmost privacy and confidentiality.</li>

                              </ul>

                              <p>Advanced Equipment   Experienced Doctors   State-of-the-art   Infrastructure   Trained Staff</p>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top Andrology & <span>Urology Specialists Today</span></h2>

				<div class="h-text"><p>Our internationally-trained surgeons have an experience of 25,000+ surgeries. Contact us!</p></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Sajid Hussain</h5></div>

                        </div>

                        <div class="testimonial-body">

                         After consulting too many places I got the best Dr. in the city Dr Gautam Banga. I am totally satisfied with the services they provide and the care they give during the surgery.  Best surgeon. Thanks Dr Banga and the highly professional team for giving immense support.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Ajay Majithia</h5></div>

                        </div>

                        <div class="testimonial-body">

                           The staff and the doctors are excellent. Courteous and dedicated to a fault. Patients are made to feel at home with personal care. And lastly my appraisal will be incomplete without special reference to Gurmeet, who is the heart and soul of the hospital and is there to help at all given times.</div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Chandra Prakash Sinha</h5></div>

                        </div>

                        <div class="testimonial-body">

                        Best treatment with the best hospitality I got here. Staff and the doctors are excellent. Specially thanks to “Dr. Gautam Banga” for the consultation and treatment.  Everything was processed smoothly. In terms of budget, the hospital is also good. I will recommend this hospital to everyone for the best treatment. </div>
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions </span>About Erectile Dysfunction</h2>

				<div class="h-text"><p>For any queries regarding the surgery, go through this FAQ section.</p></div>
                ...
                <div class="accordion" id="faq">
                   ...
                   <div class="card">
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         The chief ED causes are: Stress, Diabetes, High Blood Pressure, High Cholesterol, Substance Abuse, Low Testosterone, Pelvic Trauma, Multiple Sclerosis, Parkinson’s Disease, Peyronie’s Disease, and certain medicines. </div>
                   ...
                   <div class="card">
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           The permanent ED cure varies depending upon the causes and severity of the condition. A permanent cure for ED would still be the insertion of a penile implant.
                   ...
                   <div class="card">
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         The latest treatment options for erectile dysfunction include penile implants, orally prescribed medicines, and intraurethral suppositories. You should consult a doctor before choosing any treatment.</div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         Is surgery absolutely necessary for Erectile Dysfunction?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           A surgery is needed only when all other erectile dysfunction treatments have failed. It is, in fact, the last resort to cure impotency.  </div>
                    ...
                    <div class="card">
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Yes, lifestyle changes like increased physical activity, healthy diet, and reduced caloric intake can help manage milder cases of erectile dysfunction </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>Get your sexual life on track with our advanced Erectile Dysfunction treatments</p>
