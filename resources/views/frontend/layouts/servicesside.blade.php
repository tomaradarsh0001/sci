...
<ul class="services-nav flex-column flex-nowrap">
    ...
    <li class="nav-item"><p class="main_Services_menu"><a href="{{ route('department-of-dermatology-cosmetology-plastic-surgery') }}">Cosmetic & Plastic Surgery</a></p></li>
    <li class="nav-item"><p class="main_Services_menu"><a href="{{ route('internal-medicine-endocrinology') }}">Internal Medicine & Endocrinology</a></p></li>
    <li class="nav-item"><p class="main_Services_menu"><a href="{{ route('department-of-ophthalmology') }}">Opthalmology</a></p></li>
    <li class="nav-item"><p class="main_Services_menu"><a href="{{ route('dental-department') }}">Dental implants & Orthodontics</a></p></li>
