                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h1 class="doctor-box-name mb-2  theme-color">Dr. Juhee Jain </h1>
							<h2 class="doctor-box-name mb-2  theme-color">Specialist in Obstetrics and Gynecology</h2>
                            <p class="degree_section">MD - Obstetrics & Gynaecology</p>
                            <p class="degree_section">37 years overall (33 yrs as specialist)</p>
