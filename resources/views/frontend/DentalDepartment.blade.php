@extends('frontend.layouts.main') @section('main-container') @section('define_robots', 'index, follow') @section('define_urltype', 'website') @section('ob_img', 'https://scihospital.com/public/assets/images/sci%20logo.webp')
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="pt-2 pt-md-4">
                        ...
                        <div class="mt-3 mt-lg-6"></div>
                     <h2 class="theme-color text-center mt-3">Best Dental Doctor In Delhi</h2>
                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <div>
                        ...
                        <div class="mt-3 mt-lg-6"></div>
                        <h2 class="theme-color">Orthodontics | Best Dental Hospital In Delhi</h2>
                        <p>
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="container">
            <div class="mt-3 mt-lg-6"></div>
                <h2 class="theme-color text-center mt-3">Image Gallery</h2>
      ...
      <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                                ...
                                <h2 class="theme-color text-center mt-3">Patients Review</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
        ...
        <div class="row">
            ...
            <div class="item">
              <div class="YoutubeLazy" data-embed="iE0E4eRxY6M">
                                        <span class="YoutubeButton"></span>
                                    </div>
            </div>
            <div class="item">
              <div class="YoutubeLazy" data-embed="WAInKY-NbZA">
                                        <span class="YoutubeButton"></span>
                                    </div>
            </div>
          </div>
