                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Reconstructing ACL (Ligament Tear) to Perfection by Best Arthroscopic Surgeons</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />State-of-art Equipment & Modular OTs
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Experienced & Skilled Arthroscopic Surgeons
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />High  Success Rate 
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Major Insurance Accepted & No Cost EMI Available
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/ACL Tear Banner BG_Desktop -1440x635.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/ACL Tear Banner BG_Mobile - 415x1064.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About ACL <span>Tear</span></h2>

				<div class="h-text">

				    <p>An ACL injury, a common sports injury, is a tear or sprain of the anterior cruciate ligament (ACL), connecting the thigh bone to the shinbone.</p>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Signs that you need a <span>ACL Tear</span></h3>

                              <!--<p> </p>-->

                              <h6>The signs & symptoms of ACL Tear are:</h6>

                              <ul>

                              <li>A popping sound or a sensation in the knee</li>

                              <li>Feeling of instability, swelling & pain in the knee</li>
                              ...
                              <p>If you are experiencing any of these symptoms, you may need an ACL reconstruction surgery</p>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>The knee joint consists of a complex combination of bones, tendons, ligaments, and other tissues that function together. Thus, prompt ACL tear treatment is essential to avoid complete knee failure. If treatment is delayed, the following consequences may occur: </p>

                              <h6>The primary triggers behind hip joint damage are: </h6>

                              <ul><li>Chronic ACL Deficiency</li>

                              <li>Heightened Knee Instability</li>

                              <li>Frequent Knee Give-Outs</li>
                              ...
                              <p>You must opt for ACL tear surgery to avoid these unwanted consequences.</p>
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h6>The benefits of ACL Tear surgery are:</h6>

                              <ul>

                              <li>Reduced pain and swelling</li>

                              <li>Lower possibilities of early arthritis </li>

                              <li>Return to sports & active lifestyle</li>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>The surgery costs vary based on the surgery type, implants needed, and room chosen. Our packages start from ₹1, 25, 000 approximately (Includes 1 Day Hospital Stay) </p>
                  ...
                  <div class="tab-pane fade" id="Sci" role="tabpanel" aria-labelledby="Sci-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p> Experience the SCI difference in ACL repair. Our advanced internal bracing technique surpasses traditional methods, ensuring superior outcomes. Explore the table below to discover how SCI stands out: </p>
                              ...
                              <table style="width:100%; margin-bottom:30px;">
                                  ...
                                  <tr>
                                    ...
                                    <th>Traditional ACL surgery</th>

                                    <th>ACL Surgery at SCI</th>

                                  </tr>

                                  <tr>

                                    <td>When can I start daily activities?</td>
    ...
    <div class="section testimonial-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Our verified <span> Patient Feedbacks </span></h2>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Sneh Thakur</h5></div>

                        </div>

                        <div class="testimonial-body">

                            It has been an amazing experience in SCI Hospital. All the doctors and staff were excellent. Earlier, doctors told me that I may not be able to walk again properly but Dr. Lalit is an amazing doctor and within 3 months of my surgery I am now fully rehabilitated. Thanks to the entire SCI team for taking such good care of me.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Firdauz Mulla </h5></div>

                        </div>

                        <div class="testimonial-body">

                            As an international Kabaddi player, I suffered a knee injury during a match. Seeking aid from Dr. Nishant Soni, I underwent ACL surgery. Now, filled with immense joy, I've seamlessly resumed my daily activities. Dr. Soni's expertise not only restored my physical strength but also revitalized my spirits, enabling me to pursue my passion once again with vigor.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Sahil Arora</h5></div>

                        </div>

                        <div class="testimonial-body">

                            In April 2023, I broke my ACL while playing football. Following a teammate's recommendation, I consulted one of the doctors at SCI hospital. Impressed by his professionalism and care, I underwent successful surgery. With physiotherapy and guidance from the therapist, I recovered fully within one and a half years. I highly recommend SCI hospital for ACL treatment.
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Frequently Asked Questions About<span> ACL Tear Surgery</span> </h2>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingOne">
                         ...
                         <div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           ...
                           How to choose the best surgeon for ACL reconstruction surgery?
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Always seek out orthopedic surgeons certified by a medical board, possessing specialized expertise and training in ACL reconstruction procedures. At SCI, we have such experts.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingTwo">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           ...
                           Which is the best surgical option for ACL?
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            The best surgical option for ACL tears is Internal Brace Surgery. This technique involves using a specialized tape suture to support the reconstructed ACL.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            ...
                            When can I resume daily activities after ACL surgery?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            After the surgery, it takes six weeks to three months to resume daily activities. You must give your knee that much time to heal.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingFive">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            ...
                            Can I sit, stand, and walk without assistance after surgery?
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Use crutches initially to aid walking after surgery. Limit walking and standing for 7-10 days, and avoid prolonged sitting for up to 2 weeks.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingSix">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseFive">
                            ...
                            When can I go for a follow-up appointment?
                      ...
                      <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Your doctor will schedule a follow-up appointment one-week post-surgery for a knee examination and stitch removal, usually arranged prior to the procedure.
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>Get your torn ACL fixed to return to sports again</p>
