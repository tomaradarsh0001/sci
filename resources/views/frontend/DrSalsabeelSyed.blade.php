...
@section('define_urltype', 'website') @section('ob_img', 'https://scihospital.com/public/assets/images/doctors/Dr-Salsabeel-Syed.png')
...
<script type="application/ld+json">
{
  ...
  "url": "https://scihospital.com/our-doctors",
  "image": "https://scihospital.com/public/assets/images/doctors/Dr-Salsabeel-Syed.png",
  "sameAs": "https://scihospital.com/",
  "jobTitle": "Radiologist Consultant",
  "worksFor": {
    "@type": "Organization",
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('assets/images/doctors/Dr-Salsabeel-Syed.png')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2 theme-color">Dr. Salsabeel Syed</h5>
                            <p class="degree_section">MBBS, DMRD, DNB</p>
