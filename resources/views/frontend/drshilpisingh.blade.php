...
<script type="application/ld+json">
{
  ...
  "url": "https://scihospital.com/dr-shilpi-singh",
  "image": "https://scihospital.com/public/assets/images/doctors/Shilpi.jpg",
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('assets/images/doctors/Shilpi.jpg')}}" class="img-fluid" alt="Dr. Shilpi Singh" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h1 class="doctor-box-name mb-2  theme-color">Obstetrics and Gynecologyt | Dr. Shilpi Singh</h1>
                            <p class="degree_section">Consultant Obstetrician and Gynaecologist</p>
                        ...
                        <div class="col-lg-12">
                            <div class="tab_doctors">
                                <div class="tab_home row nav nav-pills-icons js-doc-carousel" role="tablist">
                                    ...
                                    <a class="nav-link" data-toggle="pill" href="#tab-B" role="tab"><i class="fa fa-sticky-note-o"></i> Experience</a>
                                </div>
                                <div id="tab-content" class="tab-content mt-2">
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>M.B.B.S, D.G.O</p>
                                                <p>Diploma in Cosmetic Gynaecology</p>
                                            </div>
                                        </div>
                                    </div>
                                  <div id="tab-B" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>17 years overall (15 years as specialist)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
