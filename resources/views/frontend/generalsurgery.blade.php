	...
	<div class="page-content">
		...
		<div class="section mt-0 position-relative" id="form">
					...
					<div class="row">
						...
						<div class="col-md-5 d-flex align-items-center">
							...
							<div class="hero-text" >
								...
								<h1>Latest Surgical Treatments Available Under One Roof</h1>
								...
								<ul class="stats-list">
									...
									<li class="stats-item">
										...
										<div class="stats-box">
											...
											<img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Advanced Laser & Laparoscopic Procedures
									...
									<li class="stats-item">
										...
										<div class="stats-box">
											...
											<img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Short Duration Below 30-minute Surgeries
									...
									<li class="stats-item">
										...
										<div class="stats-box">
											...
											<img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Cashless Facility for All Major Insurances & No Cost EMI Option
			...
			<div class="hero-img">
				...
				<img src="{{asset('assets/images/GeneralSurgeryDesktop.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

				<img src="{{asset('assets/images/GeneralSurgeryMobile.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
		...
		<div class="section mt-0 about-us-section" id="about">
			...
			<div class="container">
				...
				<div class="title-wrap why-us-wrap text-center">
					...
					<h2 class="h1">About <span>Our Surgical Treatments</span></h2>

					<div class="h-text">

						<p>We offer advanced, technology-backed surgical procedures for conditions like piles, fistula, fissure, and pilonidal sinus, ensuring effective treatment and patient care.</p>
				...
				<div class="row">
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						...
						<li class="nav-item" role="presentation">
							...
							<div class="nav-link" id="Treatment-tab" data-toggle="pill" data-target="#Treatment" role="tab" aria-controls="Treatment" aria-selected="false">How Do We Treat?</div>
						...
						<li class="nav-item" role="presentation">
							...
							<div class="nav-link" id="Others-tab" data-toggle="pill" data-target="#Others" role="tab" aria-controls="Others" aria-selected="false">Treatment Costs</div>
						...
						<div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
							...
							<div class="about-tab-box">
								...
								<div class="about-tab-text">
									...
									<p> Piles: Piles, also known as hemorrhoids, are swollen veins in the rectum and anus that can cause discomfort, bleeding, and itching. They are often caused by straining during bowel movements.</p>

									<h6>Symptoms of Piles</h6>

									<ul>

										<li>Rectal bleeding during bowel movements</li>

										<li>Itching or irritation in the anal region</li>

										<li>Pain or discomfort, especially while sitting</li>

										<li>Swelling or lumps around the anus</li>

									</ul>

									<p>Fissure: A fissure is a small tear or cut in the skin, often occurring in the anal region, causing pain, itching, and bleeding during bowel movements. They can be caused by constipation or trauma.</p>

									<h6>Symptoms of Fissure</h6>

									<ul>

										<li>Sharp pain during or after bowel movements</li>

										<li>Bright red blood on toilet paper or in the stool</li>

										<li>Itching or irritation in the anal area</li>

										<li>Small tear or cut visible near the anus</li>

									</ul>

									<p>Fistula: A fistula is an abnormal connection between organs or vessels, often caused by infection or inflammation, leading to an abnormal passageway.</p>

									<h6>Symptoms of Fistula</h6>

									<ul>

										<li>Continuous drainage from near anus</li>

										<li>Painful sitting or bowel movements</li>

										<li>Swelling, redness, tenderness around anus</li>

										<li>Recurrent anal infections</li>

									</ul>

									<p>Pilonidal Sinus: A pilonidal sinus is a small tunnel or cavity in the skin, typically at the top of the buttock’s cleft, often caused by ingrown hairs and prone to infection.</p>

									<h6>Symptoms of Pilonidal Sinus</h6>

									<ul>

										<li>Pain and swelling near the top of the buttocks</li>

										<li>Redness or tenderness in the affected area</li>

										<li>Formation of a small hole or pit in the skin</li>

										<li>Discharge of pus or blood from the sinus opening</li>
						...
						<div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
							...
							<div class="about-tab-box">
								...
								<div class="about-tab-text">
									...
									<h3>How Do We <span>Treat?</span></h3>

									<!--<p> </p>-->

									<h6>Treatments Used At SCI Hospital</h6>

									<p>SCI International Hospitals are a Centre of Excellence for all Proctology Procedures like Piles, Fissure, Fistula and Pilonidal Sinus.</p>

									<p>Laser surgery or Laparoscopic surgery are the treatments used for these conditions.</p>

									<h6>Our Treatment Benefits:</h6>

									<ul><li>Non-invasive or minimally invasive procedures</li>

										<li>Less pain</li>

										<li>No scarring</li>

										<li>Low blood loss or no blood loss at all</li>

										<li>Day care procedures completed within an hour</li>

										<li>No wound dressing and bed rest required</li>

										<li>No recurrence</li>

										<li>Speedy recovery</li>

										<li>Very low infection risk</li>
						...
						<div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
							...
							<div class="about-tab-box">
								...
								<div class="about-tab-text">
									...
									<p>The surgery costs vary based on the surgery type, room chosen, aftercare and patient’s health status. They are covered by a cashless insurance facility, and patients have 0% Interest EMI options available. </p>
		...
		<div class="section our-team-container mt-0" id="team">
			...
			<div class="container">
				...
				<div class="title-wrap why-us-wrap text-center">
					...
					<h2 class="h1">Meet Our Top Surgery <span>  Specialists Today</span></h2>
...
<div class="our-team-box">
	...
	<div class="our-team-img"><img src="{{asset('assets/images/doctors/dr-sanjeev-gupta.jpeg')}}" alt="Dr. Sanjeev Gupta" width="100%" class="img-fluid" /></div>

	<div class="our-team-text">

		<h3>Dr. Sanjeev Gupta</h3>

		<h5>MS - General Surgery, University of Delhi, New Delhi, 2008</h5>

		<p>Consultant - General Surgery</p>

	   <a href="{{ route('dr-sanjeev-gupta') }}" class="view-all-link">View Full Profile</a>
...
<div class="col-md">
	...
	<div class="our-team-box">
		...
		<div class="our-team-img"><img src="{{asset('assets/images/doctors/Vikrant.png')}}" alt="" width="100%" class="img-fluid" /></div>

		<div class="our-team-text">

			<h3>Dr. Vikrant S.</h3>

			<h5>Ayurvedic General Surgery </h5>

			<p>Proctologist & Surgeon</p>

			<!--   <a href="https://scihospital.com/gurgaon/dr-vikrant-singh" class="view-all-link">View Full Profile</a>-->
			...
			<a href="#form" class="btn">Consult Doctor</a>
					...
					<div class="col-md">
						...
						<div class="our-team-box">
							...
							<div class="our-team-img"><img src="{{asset('assets/images/doctors/Daipayan.png')}}" alt="" width="100%" class="img-fluid" /></div>
							...
							<div class="our-team-text">
								...
								<!--  <a href="https://scihospital.com/gurgaon/dr-daipayan-ghosh" class="view-all-link">View Full Profile</a>-->
					...
					<div class="col-md">
						...
						<div class="our-team-box">
							...
							<div class="our-team-img"><img src="{{asset('assets/images/doctors//user.png')}}" alt="" width="100%" class="img-fluid" /></div>
							...
							<div class="our-team-text">
							  ...
							  <!--  <a href="{{ route('dr-nabanita-chatterjee') }}" class="view-all-link">View Full Profile</a>-->
					...
					<div class="col-md">
						...
						<div class="testimonial-box">
							...
							<div class="testimonial-head">
								...
								<div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Ajay Majitha</h5></div>

							</div>

							<div class="testimonial-body">

								The staff and the doctors are excellent. Courteous and dedicated to a fault. Patients are made to feel at home with personal care. And lastly my appraisal will be incomplete without special reference to Gurmeet, who is the heart and soul of the hospital and is there to help at all given times.
					...
					<div class="col-md">
						...
						<div class="testimonial-box">
							...
							<div class="testimonial-head">
								...
								<!-- <div class="testimonial-img"><img src="{{asset('assets/images/testi-3.png')}}" alt="" width="100%" class="img-fluid" /></div> -->

								<div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Anu Suaya</h5></div>

							</div>

							<div class="testimonial-body">

								Doctors, Staff, Nurses, everyone was so helpful and professional. It feels like home. I strongly recommend SCI hospital and especially Dr. Rakesh Kumar General Surgery.
					...
					<div class="col-md">
						...
						<div class="testimonial-box">
							...
							<div class="testimonial-head">
								...
								<!-- <div class="testimonial-img"><img src="{{asset('assets/images/testi-5.webp')}}" alt="" width="100%" class="img-fluid" /></div> -->

								<div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Sanjna Prajapti</h5></div>

							</div>

							<div class="testimonial-body">

								I came for my surgery under Dr Raj Kumar Singh. He is a very good and friendly doctor. Hospital is neat and clean. Highly recommended to all my friends.
		...
		<div class="section faq-container mt-0">
			...
			<div class="container">
				...
				<div class="title-wrap why-us-wrap text-center">
					...
					<h2 class="h1"><span>Frequently Asked Questions About </span>Our Surgical Procedures</h2>
						...
						<div class="card">
							...
							<div class="card-header" id="headingOne">
								...
								<div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									...
									How to choose the best surgeons?
							...
							<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
								...
								<div class="card-body">
									...
									Consider experience, qualifications, patient reviews, hospital affiliation, and communication skills when choosing a surgeon. Seek recommendations and schedule consultations for personalized assessment.
						...
						<div class="card">
							...
							<div class="card-header" id="headingTwo">
								...
								<div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
									...
									How long does it typically take to recover from fistula surgery?
							...
							<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
								...
								<div class="card-body">
									...
									Recovery time varies depending on the type of surgery performed and individual healing factors. Generally, patients can expect several weeks to a few months for full recovery.
						...
						<div class="card">
							...
							<div class="card-header" id="headingThree">
								...
								<div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
									...
									What are the potential risks associated with fissure surgery?
							...
							<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
								...
								<div class="card-body">
									...
									Risks include infection, bleeding, temporary or permanent changes in bowel habits, and rare complications like anal incontinence.
						...
						<div class="card">
							...
							<div class="card-header" id="headingFour">
								...
								<div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
									...
									How soon can I expect relief from symptoms after fissure surgery?
							...
							<div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
								...
								<div class="card-body">
									...
									Symptoms typically improve within a few days to weeks after surgery, with full recovery expected within a few weeks.
						...
						<div class="card">
							...
							<div class="card-header" id="headingFive">
								...
								<div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
									...
									What surgical options are available for treating pilonidal sinus?
							...
							<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
								...
								<div class="card-body">
									...
									SCI Hospital offers surgical options such as incision and drainage, excision and closure, and minimally invasive techniques for a quick and effective pilonidal sinus treatment.
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
							...
							<p>Advanced & non-recurrent surgical solutions for a range of painful conditions</p>
