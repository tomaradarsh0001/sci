                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Latest  Knee Replacement Surgery</h1>
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/Knee Replacement Banner_BG_Desktop -1440x635.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/Knee Replacement Banner_BG_Mobile - 415x1064.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About <span>Surgery</span></h2>

				<div class="h-text">

				    <p>Knee replacement surgery is a procedure that replaces damaged knee parts with prosthetic components like metal or plastic implants to restore function and alleviate pain.

</p><p>It may be complete or partial replacement</p>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Signs that you need a <span>Knee Replacement</span></h3>

                              <!--<p> </p>-->

                              <h6>The symptoms of a Damaged Knee Joint are:</h6>
                              ...
                              <li>Constant knee pain</li>

                              <li>Irreversible knee inflammation & swelling</li>

                              <li>No relief from NSAIDs, weight loss, physiotherapy</li>

                              </ul>

                              <p>Experiencing the above symptoms? Knee replacement surgery is your only option.</p>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>A damaged knee is a debilitating issue and may make you feel miserable due to excruciating pain and immobility. </p>

                              <h6>Thus, you may need knee replacement surgery for the following reasons: </h6>

                              <ul><li>You are unable to tolerate the pain anymore.</li>

                              <li>You cannot move and have become bedridden.</li>

                              <li>You have become dependent on others for daily activities</li>

                              <li>Your quality of life has reduced.</li>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>The surgery costs vary based on the surgery type, i.e whether partial or total knee replacement is to be done, and the choice of room opted for. They are covered by insurance, and 0% EMI options are available for patients. </p>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top <span>Orthopedic Surgery Specialists Today </span></h2>

				<div class="h-text"><p>Our internationally-trained specialists have experience in 25,000+ patient cases. Contact us!</p></div>
    ...
    <div class="section testimonial-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Our verified <span> Patients Feedback </span></h2>

				<div class="h-text"><p>What Are Our Happy Patients Telling About The Treatment They Received?</p></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Ruhullah Wani</h5></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Rahul Yadav</h5></div>

                        </div>

                        <div class="testimonial-body">

                            I was impressed by the calm and attentive nature of the doctor during my visit. Despite being late due to an emergency surgery, he apologized sincerely. His genuine and humane approach was evident throughout. After thorough diagnosis, he recommended non-invasive treatment instead of knee replacement surgery, showing honesty and transparency. I was really impressed by this.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Anmol Mehta</h5></div>

                        </div>

                        <div class="testimonial-body">

                            The hospital provided excellent service to me during my treatment at the hospital. I was operated on by a highly experienced and skillful surgeon, and it was successful. I am absolutely fine now. The staff were polite, efficient, prompt and caring. Thanks to the treatment at SCI Hospital, I'm leading an active and confident life now.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingOne">
                         ...
                         <div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                           ...
                           How do I choose the best surgeon for my knee replacement surgery?
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           You must always look for board-certified Orthopedic surgeons with special expertise and training in knee replacement and substantial surgical experience.. These surgeons can handle your surgery the best way.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingTwo">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           ...
                           Is it better to get both knees replaced at the same time?
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Simultaneous knee replacements could mean less pain and quicker recovery, offering few advantages over separate procedures for both knees. But this can be decided only by you post consulting with your Orthopedic doctor.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingThree">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            ...
                            Is there much preparation prior to the surgery?
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Before surgery, you need to undergo a physical exam, pre-admission testing, and attend preoperative education. These steps, though time-consuming, ensure long-term success post knee replacement.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            ...
                            What happens if I wait too long for a knee replacement surgery?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           If left untreated, damaged bone, cartilage, and ligaments can lead to deteriorating knee joints and function loss. This can cause increased pain, and altered walking.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingFive">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            ...
                            Will there be too much pain after the knee surgery?
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            While some pain is expected post-surgery, our team of pain management specialists work to control it. Factors like pain tolerance, physical condition affect pain levels.
                    ...
                    <div class="card">
                      ...
                      <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Returning to work depends on your profession. Sedentary roles may resume in 3-6 weeks, while labor-intensive jobs may take up to 3 months or more.
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>End your knee troubles and be back on your feet.</p>
