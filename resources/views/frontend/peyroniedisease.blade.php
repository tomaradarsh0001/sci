                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Best Solution For Painful Erections With Our Advanced Peyronie Disease Treatment</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />High Volume Peyronie's management & surgical centre
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Very high success and patient satisfaction rates 
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Permanent solution
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/PeyroniesDesktop.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/PeyroniesMobile.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="main-sbox">
                        ...
                        <div class="sbox-text">
                            ...
                            <p> Reconstructive Urology surgeries</p>
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About Peyronie’s  <span>Disease</span></h2>

				<div class="h-text">

				    <p>Peyronie's disease causes penis curvature, pain, and erectile dysfunction. Fibrous scar tissue forms within the penis, leading to deformity during erections and discomfort. Treatment options vary.</p>
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item active" role="presentation">
                    ...
                    <div class="nav-link" id="Symptoms-tab" data-toggle="pill" data-target="#Symptoms" role="tab" aria-controls="Symptoms" aria-selected="true">Features & Attributes of Our Treatment</div>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Features & Attributes of <span>Our Treatment</span></h3>
                              ...
                              <li>Specialized Peyronie’s Disease Management and Penile Prosthesis Centre</li>

                              <li>Exceptional Patient Satisfaction with High-Volume Care</li>

                              <li>Expert Assessment and Counseling for Penile Curvature</li>

                              <li>Comprehensive Treatment for Bent Penis and Penile Injuries</li>

                              <li>Definitive Solutions for Lasting Results</li>
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <li>Corrects Penile Curvature: Surgery straightens the penis, improving appearance and function.</li>

                              <li>Improves Erectile Function: Enhances blood flow for better erections. </li>

                              <li>Alleviates Pain: Surgery removes scar tissue, reducing discomfort.</li>

                              <li>Enhances Confidence: Successful surgery boosts self-esteem and sexual confidence.</li>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>Our Peyronie’s Surgery costs vary by treatment plan and room category choice, and are covered by insurance, with 0% Interest EMI available.</p>
               ...
               <!-- <div class="col-md">
                 ...
                 <!--<div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-img"><img src="https://scihospital.com/public/assets/images/doctors/dr-mayank-garg-urologist.webp" alt="" width="100%" class="img-fluid" /></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-body">
                            ...
                            Meri penile implant surgery done under Dr Gautam Banga. He is a very kind and humble person. Thank you so much Dr Gautam Banga. Hospital all services are good
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Chandra Prakash Sinha</h5></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Kuldeep Singh</h5></div>

                        </div>

                        <div class="testimonial-body">

                            I was consulting too many places in NCR but got information from my relatives about the SCI. I met with Dr Gautam Banga. Now I am satisfied with surgery and service. I think the best surgeon. Thanks Dr. Banga ji, Ms Gurmeet Kaur ji and all top to bottom team of SCI
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions About </span> Peyronie’s Disease Surgery</h2>
                   ...
                   <div class="card">
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                          ...
                          Peyronie's disease often results from penile trauma, causing scar tissue buildup and curvature, affecting sexual function and intimacy.
                   ...
                   <div class="card">
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Diagnosis involves physical examination, medical history review, and possibly imaging tests to assess penile curvature and plaque formation.
                   ...
                   <div class="card">
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Treatment options vary and may include medication, injections, traction therapy, or surgery, depending on the severity and symptoms.
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                           ...
                           Is surgery always necessary for Peyronie's disease?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Surgery is typically considered when conservative treatments fail to provide relief or when curvature significantly affects sexual function.
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingFive">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            ...
                            What are the potential risks of Peyronie's disease treatments?
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Risks vary depending on the treatment chosen but may include pain or, infection.
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>Relieve Peyronie's disease pain & discomfort with our world-class treatment options.</p>
