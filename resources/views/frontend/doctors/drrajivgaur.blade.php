                ...
                <div class="container doctor_details_section">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <h5 class="doctor-box-name mb-2  theme-color">Dr. Rajiv Gaur </h5>
                            <p class="degree_section">Internal Medicine </p>
                            ...
                            <div class="tab_doctors">
                                ...
                                <div id="tab-content" class="tab-content mt-2">
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Dr. Rajiv Gaur is a highly skilled and compassionate specialist in Internal Medicine with an impressive medical career spanning 26 years. His dedication to the field of medicine has made him a trusted name in the industry, known for his expertise and empathetic patient care.  </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab-B" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Dr. Rajiv Gaur, an Internal Medicine specialist with 26 years of experience, including 21 as a specialist, excels in noninvasive cardiac tests and critical care for cardiac patients. His expertise ensures top-quality patient care. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="tab-C" class="tab-pane fade" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>Dr. Rajiv Gaur's outstanding career boasts numerous achievements. He's renowned for precise diagnoses, compassionate care, and meticulous attention to detail. Patients and peers respect his unwavering commitment to improving health and well-being. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
