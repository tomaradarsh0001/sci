                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Remove Kidney Stones With Cutting-edge Laser Technology</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" /> Painless 30-minute laser procedure with no cuts & stitches
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Get a Quick Recovery
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />All Major Insurances Accepted and No Cost EMI
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/Kidney Stone Banner_Desktop.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/Kidney Stone Banner_BG_Mobile - 415x1064.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<div class="h-text">
				    ...
				    <p>RIRS (Retrograde Intrarenal Surgery), a non-invasive method, treats kidney stones by navigating a flexible scope through the urinary tract, avoiding incisions. It's preferred for its minimal discomfort and swift recovery.</p>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Signs that you need a <span>Kidney Stones</span></h3>

                              <!--<p> </p>-->

                              <h6>The symptoms of kidney stone formation are:</h6>
                              ...
                              <li>Constant vague pain in the lower abdomen</li>

                              <li>Cloudy and foul-smelling urine</li>
                             ...
                             <li>Fever and chills</li>
                              ...
                              <p>Experiencing the above symptoms? Opt for the RIRS Method for non-invasive, painless kidney stone removal</p>
                  ...
                  <div class="tab-pane fade" id="Treatment" role="tabpanel" aria-labelledby="Treatment-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                            ...
                            <h3>Why Is Treatment <span>Needed?</span></h3>

                              <p>Kidney stones are a common medical condition these days. While most kidney stones get flushed out on their own, some stubborn ones may require a procedure. Treating kidney stones is necessary as any delay could lead to unwanted complications, such as:</p>

                            <!--  <h6>The primary triggers behind hip joint damage are: </h6>-->

                              <ul><li>Decline in Kidney Function</li>

                              <li>Frequent Urinary Tract Infections</li>

                              <li>Permanent Kidney Damage & Failure</li>

                              <li>Chronic Discomfort & Sleep Disruption</li>

                              <li>Enlargement In Stone's Size</li>
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h6>The benefits of the RIRS method are:</h6>

                              <ul>

                              <li>Painless stone removal in just 30 minutes</li>

                              <li>Non-invasive method without cuts & stitches</li>

                              <li>Quick relief from pain & discomfort</li>

                              <li>Quick recovery</li>

                               <li>No recurrence of stones</li>
                  ...
                  <div class="tab-pane fade" id="Others" role="tabpanel" aria-labelledby="Others-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>The surgery costs vary based on the stones’ size, number & location, the equipment and techniques used, and the room chosen.</p>
                  ...
                  <div class="tab-pane fade" id="Sci" role="tabpanel" aria-labelledby="Sci-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <p>Experience the SCI difference in Kidney Stone Removal. Our advanced laser technology surpasses traditional methods, ensuring superior outcomes. Explore the table below to discover how SCI stands out:</p>
                              ...
                              <table style="width:100%; margin-bottom:30px;">
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    ...
                                    <td>Slow & prolonged period of bed rest required</td>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top Urologists & <span>Renal Experts</span></h2>
            ...
            <div class="owl-carousel owl-theme" id="lp_page_doctor">
                ...
                <div class="our-team-box">
                    ...
                    <div class="our-team-img"><img src="{{asset('public/temp/img/Dr-Vishal-Dutt-Gour-1.png')}}" alt="Dr. Vishal Dutt Gour" width="100%" class="img-fluid" /></div>
                    ...
                    <div class="our-team-text">
                        ...
                        <p>Urologist, Urological Surgeon, Andrologist</p>
                ...
                <!-- <div class="col-md">
                    ...
                    <div class="our-team-box">
                        ...
                        <div class="our-team-text">
                            ...
                            <h5>Urologist & Andrologist </h5>

                            <p>General Surgery</p>

                           <a href="https://scihospital.com/dr-mayank-garg-urologist" class="view-all-link">View Full Profile</a>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span> 3 months ago</span><h5>Arun Khokhar</h5></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Akash Singh </h5></div>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Amrit Patel</h5></div>

                        </div>

                        <div class="testimonial-body">

                           SCI Hospital's laser kidney stone removal transformed my life. The procedure, expertly conducted by their team, was remarkably smooth and painless. Thanks to their care, I swiftly recovered, resuming my daily activities without hindrance. SCI's exceptional expertise and support were instrumental, and I am deeply appreciative of their commitment to my well-being. </div>
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions About </span>RIRS Stone Removal</h2>

				<div class="h-text"><p>For any queries regarding the procedure, go through this FAQ section.</p></div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingOne">
                         ...
                         <div class="btn-link btn-block text-left"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                          ...
                          Does the RIRS method for kidney stones cause pain?
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         <div class="card-body">
                          ...
                          The procedure done under anesthesia ensures pain-free treatment without cuts or stitches. However, there might be mild post-procedure discomfort due to stent insertion.</div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingTwo">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                          ...
                          When can I go back home after the RIRS procedure?
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           RIRS enables patients to return home on the same day, minimizing hospital stays. However, discharge depends on a thorough evaluation of overall health status. </div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingThree">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                           ...
                           How much time does the RIRS procedure require?
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Typically, the procedure lasts 30-45 minutes, varying based on factors like stone complexity, doctor's experience, and patient's health status. </div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-header" id="headingFour">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                          ...
                          Whom should I consult for the RIRS procedure?
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           For the RIRS procedure, consult a board-certified Urologist, specializing in urinary tract issues, for accurate diagnosis and tailored treatment. </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="headingFive">
                         ...
                         <div class="btn-link btn-block text-left collapsed"  data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            ...
                            Does the RIRS procedure involve risk?
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Risks related to the RIRS kidney stone removal procedure are minimal compared to other invasive procedures such as open surgery, PCML, and ESWL</div>
                   ...
                   <div class="card">
                      ...
                      <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Recovery post-RIRS Surgery is typically brief, with patients resuming normal activities within 1-2 days due to its non-invasive nature and low complication risk.</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <h2>Book an Appointment Today!</h2>
                         ...
                         <p>Get rid of kidney stones with our advanced laser treatment</p>
