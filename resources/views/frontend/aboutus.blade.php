...
<div class="page-content gg">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 text-center pr-md-4 doc_about_sec">
                    <img src="{{asset('assets/images/SHIVANI.jpg')}}" class="w-100" alt="SHIVANI" />
                    <h4>DR SHIVANI SACHDEV GOUR</h4>
                    <p>Founder & Medical Director At SCI</p>
                </div>
                <div class="col-lg-3 text-center pr-md-4 doc_about_sec">
                    <img src="{{asset('assets/images/VISHAL.jpg')}}" class="w-100" alt="VISHAL" />
    ...
    <div class="section page-content-first">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 text-center" style="display:none;">
                    <div class="doctor_ab">
                        <img src="{{asset('assets/images/doctors/Dr-Mamta-Goel-1.png')}}" class="w-100" alt="" />
                        <h5 class="name_ab_doc">Dr. Mamta Goel</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="doctor_ab">
                        <img src="{{asset('assets/images/SHIVANI.jpg')}}" class="w-100" alt="" />
                        <h5 class="name_ab_doc">DR SHIVANI SACHDEV GOUR</h5>
                    </div>
                </div>
                ...
                <!--<div class="col-lg-3 col-md-6 text-center">
                    <div class="doctor_ab">
                        <img src="{{asset('assets/images/doctors/Dr-Someshwar-Singh-2.png')}}" class="w-100" alt="" />
                        <h5 class="name_ab_doc">Dr. Shomeshwar Singh</h5>
                    </div>
                </div>-->
                 <div class="col-lg-4 col-md-6 text-center">
                    <div class="doctor_ab">
                        <img src="{{asset('assets/images/doctors/Dr-Vishal-Dutt-Gour-1.png')}}" class="w-100" alt="" />
                        <h5 class="name_ab_doc">Dr. Vishal Dutt Gour</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="doctor_ab">
                        <img src="{{asset('assets/images/doctors/Dr-Gautam-Banga-2.png')}}" class="w-100" alt="" />
