                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3">
                            <div class="doctor_img_detail">
                                <img src="{{asset('assets/images/doctors/Handa.webp')}}" class="img-fluid" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h1 class="doctor-box-name mb-2  theme-color">Dr. Lokesh Handa | Plastic Surgeon</h1>
                            <p class="degree_section">MS,Mch (Plastic surgeon)</p>
                        ...
                        <div class="col-lg-12">
                            <div class="tab_doctors">
                                <div class="tab_home row nav nav-pills-icons js-doc-carousel" role="tablist">
                                    <a class="nav-link active" data-toggle="pill" href="#tab-A" role="tab"><i class="fa fa-university"></i>  DETAILS</a>
                                    ...
                                    <div id="tab-A" class="tab-pane fade in active" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 h-100">
                                                <p>MS,Mch Plastic Surgery Sr. Consultant ,Cosmetic and Hair Transplant Surgery  </p>
                                                <p>12 years overall  </p>
                                            </div>
                                        </div>
                                    </div>
