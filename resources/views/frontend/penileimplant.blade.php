                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex align-items-center">
                        ...
                        <div class="hero-text">
                            ...
                            <h1>Path-breaking Penile Implant Surgery to heighten your satisfaction & confidence</h1>
                            ...
                            <ul class="stats-list">
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />Advanced Surgery Treatments
                                ...
                                <li class="stats-item">
                                    ...
                                    <div class="stats-box">
                                        ...
                                        <img src="{{asset('assets/images/check.png')}}" alt="" width="100%" class="img-fluid" />High-quality Imported Implants 
...
function tooltipShow665927000000872029(el){
	...
	if(tooltipDisplay == 'none'){
        ...
        <div class="hero-img">
            ...
            <img src="{{asset('assets/images/PenileImplant_BG_Desk.png')}}" alt="" width="100%" class="img-fluid d-none d-md-block" />

            <img src="{{asset('assets/images/PenileImplantBanner_Mob.png')}}" alt="" width="100%" class="img-fluid d-block d-md-none" />
    ...
    <div class="section mt-0 about-us-section" id="about">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">About Penile <span>Implant Surgery</span></h2>

				<div class="h-text">

				    <p>Penile implant surgery or penile prosthesis involves inserting a crescent-shaped, medical-grade silicone device into the penis and scrotum, enhancing function.</p>
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item active" role="presentation">
                    ...
                    <div class="nav-link" id="Symptoms-tab" data-toggle="pill" data-target="#Symptoms" role="tab" aria-controls="Symptoms" aria-selected="true">How Do We Do a Penile Implant?</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Treatment-tab" data-toggle="pill" data-target="#Treatment" role="tab" aria-controls="Treatment" aria-selected="false">Benefits</div>

                  </li>

                  <li class="nav-item" role="presentation">

                    <div class="nav-link" id="Benefits-tab" data-toggle="pill" data-target="#Benefits" role="tab" aria-controls="Benefits" aria-selected="false">Surgery Costs</div>
                  ...
                  <div class="tab-pane fade active in" id="Symptoms" role="tabpanel" aria-labelledby="Symptoms-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>How Do We Do a <span>Penile Implant</span></h3>

                              <p>To do a penile implant, the doctor makes an incision just above the penis and then inserts the implant through the incision on the penis shaft. While performing the surgery, the doctor makes sure the implant used fits the shape and size of the penis.</p>

                             

                            <!--  <p>If you are experiencing any of these symptoms, you may need a hip replacement surgery</p>-->
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                           ...
                           <!--   <h6>The primary triggers behind hip joint damage are: </h6> -->
                              ...
                              <li>Rebuild Self Confidence and Believe</li>

                              <li>Enhanced Personal Attachment and Relationships</li>

                              <li>An Authentic Sexual Interaction</li>

                               <li>Provide You a Happy Life</li>

                              </ul>

                              <P>A person's erectile problem (ED) can affect many parts of their life, not just the bedroom. Penile implants may be a way for men to break out of this loop and get their health and vitality back.</P>

                          <p>Changes in mental health, physical movement, and social connections that are good have all been linked to better sexual function.</p>

                          <h6>Permanent Fix:</h6>

                          <p>Only with a Penile implant, it is possible to cure your erectile dysfunction. Implants, unlike medicines or other treatments, are made to treat erectile dysfunction forever. Long-term planning lessens the frequency of check-ins and course corrections, letting people give more attention to feeling the moment.</p>
                  ...
                  <div class="tab-pane fade" id="Benefits" role="tabpanel" aria-labelledby="Benefits-tab">
                      ...
                      <div class="about-tab-box">
                          ...
                          <div class="about-tab-text">
                              ...
                              <h3>Surgery <span>Costs</span></h3>

                              <p>Our Penile Implant Surgery costs vary by type of implant used, aftercare and room choice, and are covered by insurance, with 0% Interest EMI available.</p>

                            <p>Call Us For Cost Enquiry.</p>
    ...
    <div class="section our-team-container mt-0" id="team">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1">Meet Our Top Andrology & <span>Urology Surgery Specialists Today!</span></h2>
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>9 months ago </span><h5>Sadhu Saran </h5></div>

                        </div>

                        <div class="testimonial-body">

                           Meri penile implant surgery was done under Dr Gautam Banga. He is a very kind and humble person. Thank you so much Dr Gautam Banga. All services of the hospital are good.
                ...
                <div class="col-md">
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial-head">
                            ...
                            <div class="testi-info"><img src="{{asset('assets/images/rating.png')}}" alt="" width="100%" class="img-fluid rating" /><span>7 months ago</span><h5>Sanjeev Barman</h5></div>

                        </div>

                        <div class="testimonial-body">

                         All the staff of the hospital, all the nurse staff are very good and special Dr. Gautam Banga is the senior consultant and his team is a very good team.  I am very grateful to Dr. Ashutosh and Management Officer Mrs. Gurmeet for the excellent treatment and finally I thank Dr. Gautam Banga from the bottom of my heart.
     ...
     <div class="section faq-container mt-0">
        ...
        <div class="container">
            ...
            <div class="title-wrap why-us-wrap text-center">
				...
				<h2 class="h1"><span>Frequently Asked Questions About </span>Penile Implant Procedure </h2>
                ...
                <div class="accordion" id="faq">
                   ...
                   <div class="card">
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faq">
                         ...
                         Penile implants are durable, with a typical lifespan of 20 years.  </div>
                   ...
                   <div class="card">
                      ...
                      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faq">
                         ...
                         <div class="card-body">
                            ...
                            Candidates are typically men with erectile dysfunction who haven't responded to other treatments like medications or injections.
                   ...
                   <div class="card">
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faq">
                         ...
                         <div class="card-body">
                          ...
                          Penile implants are highly effective, with satisfaction rates exceeding 90%, providing reliable erections and improving sexual performance. </div>
                   ...
                   <div class="card">
                      ...
                      <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Risks include infection, device malfunction, and erosion. However, complications are very rare and can often be managed with medical attention. </div>
                    ...
                    <div class="card">
                      ...
                      <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#faq">
                         ...
                         <div class="card-body">
                           ...
                           Recovery typically takes a few weeks, with temporary restrictions on physical activities. Most men resume sexual activity within 4-6 weeks post-surgery. </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="book-appoinetment-box" style="background-image: url(public/assets/images/book-appointment-design.png);">
                        ...
                        <p>Regain confidence & restore intimacy with our Penile Implant Surgery</p>
