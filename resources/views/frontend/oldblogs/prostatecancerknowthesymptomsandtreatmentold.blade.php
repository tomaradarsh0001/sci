...
<meta http-equiv="refresh" content="0;https://scihospital.com/blog/prostate-cancer-know-the-symptoms-and-treatment">
            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    <div class="blog-card-details">
                        ...
                        <h5>Benign Prostatic Hyperplasia (BPH): </h5>
                        <ul class="list_blog">
                        ...
                        <h5>Know the Causes: </h5>
                        <p><b>Age:</b> It is a risk factor and found in the men whose age is more than 40. The damage to genetic material (DNA) of prostate cells can be seen in men above the age of 55. The damage or abnormal prostate can be out of control and form tumors.</p>
                        ...
                        <p><b>Family History:</b> The men are likely to get the disease if their father or brother has it. The risk gets increased when the number of relatives is diagnosed with the disease.</p>
                        
                        <p><b>Geographic Location:</b>  The death from prostate cancer is higher in North America or Europe. It may be due to screening procedures, lack of exercise habits, and environmental exposures.</p>
                        
                        <p><b>Smoking:</b> A study says that smoking increases the change of prostate cancer. Well!! Within 10 years of quitting smoking, the risk of prostate cancer goes down.</p>
                         
                        <p><b>Diet:</b> The excessive intake of animal fats and refined sugar can fetch you from poor health. Proper exercise and intake of a sufficient amount of fruits and vegetables are mandatory.</p>
                        
                        <h5>Learn About The Treatment Options </h5>
                        <p>The treatment depends on the stage and it can be screened in two ways:-</p>
                        <ul class="list_blog">
                            <li>The prostate-specific antigen (PSA) blood test.</li>
                            <li>Digital Rectal Examination (DRE)</li>
                        </ul>
                        
                        <p>After screening, the available therapies are:-</p>
                        ...
                        <h5>Radiation  </h5>
                        <p>It is an effective way to damage the cancer cells’ DNA and they die without replicating themselves.</p>
                        
                        <h5>Hormone Treatment   </h5>
                        <p>It is called androgen deprivation therapy (ADT) which is designed to stop the testosterone from being produced by blocking it from acting on the prostate cancer cells.</p>
                        <p>It is advisable to consult a doctor who will be able to design a treatment plan to maintain a healthy life.</p>
