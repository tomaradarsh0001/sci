    ...
    <div class="section page-content-first mt-3">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/endometriosis-treatment" class="d-flex">
                            <div class="icon_box">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/fibroid-treatment" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/ovarian-cryst-treatment" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/obstetricsand-gynecology" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/vaginal-tightening-surgery" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/hymen-repair-surgery" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/kidney-stones" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/enlarged-prostate" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/hypospadias" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/male-infertility" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/urology-and-andrology" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/fistula-treatment" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/bariatric-surgery" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/piles-treatment" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/advanced-laparoscopic-general-surgery" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/orthopaedic" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/paeds-orthopaedics" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/sports-injury-treatment" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="services_box">
                        <a href="https://scihospital.com/allurion-balloon-surgery" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            ...
            <div class="services_box">
                        <a href="https://scihospital.com/neontology-and-paeds" class="d-flex">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
        ...
        <div class="container pt-5">
            <div class="services_box">
                        <a class="d-flex" href="https://scihospital.com/">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
            ...
            <div class="services_box">
                        <a class="d-flex" href="https://scihospital.com/health-check-up">
                            <div class="icon_box">
                                <i class="fa fa-thumbs-o-up"></i>
                            </div>
                            <div class="content_box_service">
